...
const MainPage = props => {
  ...
  switch (props.pageContext.slug) {
    ...
    case '/login/callback':
      return <OauthPage {...pageProps} />
    case '/logout':
      return <LogoutPage {...pageProps} />
    case '/signup':
      return <SignupPage {...pageProps} />
    case '/confirm':
      return <ConfirmPage {...pageProps} />
    case '/model':
      return <CreateModelPage {...pageProps} />
    case '/create':
    case '/recreate':
    ...
    default:
      if (props.pageContext.slug.slice(0, 8) === '/account') return <AccountPage {...pageProps} />
      else if (props.pageContext.slug.slice(0, 8) === '/welcome')
        return <WelcomePage {...pageProps} />
      else if (props.pageContext.slug.slice(0, 7) === '/models')
        return <ModelsPage {...pageProps} />
      else if (props.pageContext.slug.slice(0, 8) === '/recipes')
        return <RecipesPage {...pageProps} />
      else if (props.pageContext.slug.slice(0, 8) === '/patrons')
        return <PatronsPage {...pageProps} />
      else if (props.pageContext.slug.slice(0, 6) === '/users') return <UsersPage {...pageProps} />
      else if (props.pageContext.slug.slice(0, 11) === '/blog/years')
        return <BlogYearPage {...pageProps} year={props.uri.split('/').pop()} />
        ...
        return <ShowcasePostPage {...pageProps} />
      else if (props.pageContext.slug.slice(0, 6) === '/docs/')
        return <DocumentationPage {...pageProps} />
