...
const PatternPage = props => {
  ...
  for (let i = 1; i <= info.difficulty; i++)
    difficulty.push(<span style={styles.star}><StarIcon /></span>);
    ...
    <React.Fragment>
      ...
      <div style={styles.wrapper}>
        <div style={styles.col}>
          ...
          <img src={"/patterns/"+props.pattern+".jpg"} alt={props.pattern} className="shadow" style={styles.img}/>
        </div>
        <div style={styles.col}>
          <Button
            style={styles.button}
          ...
          <table style={styles.table}>
            <tbody>
              ...
              <tr>
                ...
                <td style={styles.valTd}><FormattedMessage id={"filter.type." + info.type} /></td>
              </tr>
              <tr>
                <td style={styles.keyTd}>
        ...
        <div>
          <h2><FormattedMessage id="app.requiredMeasurements" /></h2>
          <PatternMeasurements pattern={props.pattern} app={props.app} />
        </div>
        <div>
          <h2><FormattedMessage id="app.patternOptions" /></h2>
          <PatternOptions pattern={props.pattern} app={props.app} />
        </div>
      </div>
      <h2><FormattedMessage id="app.showcase" /></h2>
      <div style={styles.wrapper}>
        {
