...
const PageTemplate = props => {
  ...
  let main = null
  if (props.pageContext.slug === '/blog') main = <BlogIndexTemplate {...props} {...extraProps} />
  ...
  else if (props.pageContext.slug.slice(0, 10) === '/showcase/' && patterns.indexOf(trailer) !== -1)
      ...
      <div className="fs-sa">
        <section>
          <article style={styles.body}>
            <Breadcrumbs crumbs={props.pageContext.crumbs} pageTitle={pageTitle} />
            {main}
