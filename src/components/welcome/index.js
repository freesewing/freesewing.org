...
const Welcome = ({ slug, app }) => {
  ...
  let main = (
    <React.Fragment>
      <p>
        <FormattedMessage id="app.letUsSetupYourAccount" />. We'll walk you through the following
        steps:
      </p>
      {renderSteps()}
      <p>
        While all these steps are optional, we recommend you go through them to get the most out of
        FreeSewing.
      </p>
      <p style={{ textAlign: app.frontend.mobile ? 'left' : 'right' }}>
